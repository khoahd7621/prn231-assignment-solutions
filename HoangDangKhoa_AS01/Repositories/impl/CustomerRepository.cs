...
namespace Repositories.impl
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public Customer GetCustomerById(int id) => CustomerDAO.FindCustomerById(id);
        ...
        public List<Order> GetOrders(int customerId) => OrderDAO.FindAllOrdersByCustomerId(customerId);
    }
}
